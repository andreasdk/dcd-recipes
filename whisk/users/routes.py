...
def register():
    ...
    """
    Registration function that calls the RegistrationForm class from user/form.py
    Checks if username is unique, hashes password, assigns random avatar to user,
...
def update_password(username):
    ...
    """
    Change password functions allows user to update password. The Password form
    is called from users/form.py. User must enter current password, then enter and
